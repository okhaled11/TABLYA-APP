        ...
        try {
          ...
          if (!selectedMonth || selectedMonth < 1 || selectedMonth > 12) {
            return {
              error: {
                message:
                  "Invalid month supplied. Month should be between 1 and 12.",
              },
            };
          }
          ...
          const monthStart = new Date(
            Date.UTC(targetYear, selectedMonth - 1, 1)
          );
          const nextMonthStart = new Date(
            Date.UTC(targetYear, selectedMonth, 1)
          );
          ...
          const weeklyOrders = buildWeekBuckets(
            orders,
            targetYear,
            selectedMonth
          );
        ...
        try {
          ...
          if (!targetWeek || targetWeek < 1 || targetWeek > 52) {
            return {
              error: {
                message:
                  "Invalid week supplied. Week should be between 1 and 52.",
              },
            };
          }
          ...
          return {
            error: {
              message:
                error.message || "Failed to fetch cooker weekly analytics.",
            },
          };
        }
      },
        ...
        try {
          ...
          if (!selectedDay || selectedDay < 1 || selectedDay > 31) {
            return {
              error: {
                message:
                  "Invalid day supplied. Day should be between 1 and 31.",
              },
            };
          }
          ...
          const dayStart = new Date(
            Date.UTC(targetYear, selectedMonth - 1, selectedDay)
          );
          ...
          const hourlyOrders = buildHourlyBuckets(
            orders,
            targetYear,
            selectedMonth,
            selectedDay
          ...
          return {
            error: {
              message:
                error.message || "Failed to fetch cooker daily analytics.",
            },
          };
        }
      },
