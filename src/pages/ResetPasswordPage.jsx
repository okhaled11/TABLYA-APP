                          ...
                          >
                            <List.Indicator asChild>
                              <Box as="span" mr={2} display="inline-flex" alignItems="center">
                                {rule.valid ? (
                                  <CheckCircle weight="fill" color="var(--chakra-colors-green-500)" size={16} />
                                ) : (
                                  <XCircle weight="fill" color="var(--chakra-colors-gray-400)" size={16} />
                                )}
                              </Box>
                            </List.Indicator>
                            {rule.label}
          ...
          >
            ...
            >
              ...
              <Text
                ...
                maxW="sm"
              >
                Secure your account and get back to discovering delicious homemade meals.
              </Text>
            </MotionBox>
          </Box>
        </MotionFlex>
